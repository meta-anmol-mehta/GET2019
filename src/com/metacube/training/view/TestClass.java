...
public class TestClass {
	...
	CartFacade cart = BaseFactory.createCartFacade(DBType.INMEMORY);
	...
	public void testPostiveAddToCart() {
		initialize();
		cart.setDao(memoryDao);
		assertEquals(Status.SUCCESS, cart.addProductToCart(1,1));
	...
	public void testNegativeAddToCart() {
		initialize();
		cart.setDao(memoryDao);
		assertEquals(Status.FAILURE, cart.addProductToCart(-1, 1));
	...
	public void testCornerAddToCart() {
		...
		assertEquals(Status.DUPLICATE, cart.addProductToCart(1, 1));
